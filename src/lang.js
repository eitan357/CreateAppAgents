...
const TRANSLATIONS = {
  en: {
    ...
    reqsDraftSaved:    '📄  Requirements draft saved to:',
    reqsDraftHint:     'You can open and edit this file before continuing.',
  ...
  he: {
    ...
    reqsDraftSaved:    '📄  טיוטת הדרישות נשמרה ב:',
    reqsDraftHint:     'תוכל לפתוח ולערוך את הקובץ לפני שממשיכים.',
