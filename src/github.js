...
// Push the generated code from outputDir to GitHub
function pushToGithub(outputDir, owner, repo, token) {
  ...
  // Configure identity if not set (needed in CI / fresh environments)
  ...
  try { run('git commit -m "Initial commit — generated by CreateApp Agents"'); } catch { /* nothing new */ }
...
module.exports = { parseGithubRepo, checkGithubAccess, createGithubRepo, pushToGithub };
